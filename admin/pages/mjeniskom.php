...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Jenis Kompetensi</li>
        </ol>
    </nav>
    <div class="shadow mb-4 p-3">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="alert-danger alert-dismissible fade show px-2 py-2 rounded" role="alert">
                        <strong>Catatan</strong> Pastikan Bobot Total Maksimal
                        Adalah 100%
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal" method="post" action="modal/p_jenis_kompetensi.php">
                                ...
                                <div class="form-group row">
                                    <label for="nama_kompetensi" class="col-sm-4 col-form-label col-form-label-sm">Jenis
                                        Kompetensi<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="nama_kompetensi" name="nama_kompetensi" value="<?= isset($nama_kompetensi) ? $nama_kompetensi : ""; ?>" placeholder="Nama Kompetensi" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="bobot_kompetensi" class="col-sm-4 col-form-label col-form-label-sm">Bobot Kompetensi<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="bobot_kompetensi" name="bobot_kompetensi" value="<?= isset($bobot_kompetensi) ? $bobot_kompetensi : ""; ?>" placeholder="Bobot Kompetensi" required>
                                    </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="table-responsive">
                        <table class="table text-center table-hover order-table w-100 display" id="myTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm btn_info_jenis_kompetensi m-1" id="<?= $row['id_kompetensi']; ?>"><span><i class="fas fa-search"></i>
                                                    Detail</span></button>
                                            <a href="index.php?p=mjeniskom&ubah=true&id_kompetensi=<?= $row['id_kompetensi']; ?>" class="btn btn-warning btn-sm" id="<?= $row['id_kompetensi']; ?>"><span><i class="fas fa-edit m-1"></i>
                                                    Ubah</span></a>
                                            <button href="#" class="btn btn-danger btn-sm btn_hapus_jenis_kompetensi m-1" id="<?= $row['id_kompetensi']; ?>"><span><i class="fas fa-trash"></i>
                                                    Hapus</span></button>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<div class="modal fade infolengkap" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Jenis Kompetensi</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
