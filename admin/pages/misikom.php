    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"
                aria-current="page">Isi Kompetensi</li>
        </ol>
    </nav>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal"
                                      method="post"
                                      action="modal/p_isi_kompetensi.php">
                                    <input type="hidden"
                                           id="id_isi"
                                           name="id_isi"
                                           value="<?= isset($id_isi) ? $id_isi : ""; ?>">
                                    <div class="form-group row">
                                        <label for="id_kompetensi"
                                               class="col-sm-3 col-form-label col-form-label-sm">Jenis
                                            Kompetensi</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="isi_kompetensi"
                                               class="col-sm-3 control-form-label col-form-label-sm">Isi
                                            Kompetensi</label>
                                        <div class="col-sm-9">
                        ...
                        <table class="table text-center table-hover order-table display w-100"
                            ...
                            <thead class="table-success">
                                <tr>
                                    ...
                                    <th scope="col"
                                        class="text-center align-middle">Isi Kompetensi</th>
                                    <th scope="col"
                                        class="text-center align-middle">Penilai</th>
                                    <th scope="col"
    ...
    <div class="modal fade infolengkap"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="exampleModalLabel">Data Isi Kompetensi</h5>
                    <button type="button"
                            class="close"
                            data-bs-dismiss="modal"
                            aria-label="Close">
    ...
    <div class="modal fade hapusdata"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="exampleModalLabel">Hapus Data Isi Kompetensi</h5>
                    <button type="button"
                            class="close"
                            data-bs-dismiss="modal"
                            aria-label="Close">
