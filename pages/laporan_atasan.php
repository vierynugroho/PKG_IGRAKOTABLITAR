        ...
        <div class="row">
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col d-flex align-items-end justify-content-end">
                        <a class="btn btn-success pull-right"
                           ...
                           title="Print"
                           href="pages/pdf.php"><i class="fas fa-print"></i>
                            Print</a>
                    </div>
                </div>
                <br>
                <div class="table-responsive">
                    <table class="table text-center order-table w-100 display"
                           id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="index.php?p=laporanpen&detail=<?= $row['nip'] ?>"
                                       data-bs-toggle="tooltip"
                                       data-bs-placement="top"
                                       title="Detail"><i class="fas fa-search"></i> Detail</a>
                                    <a class="btn btn-outline-danger btn-sm"
                                       href="pages/pdf.php?detail=<?= $row['nip'] ?>"
                                       target="blank"
                                       data-bs-toggle="tooltip"
                                       data-bs-placement="top"
                                       title="Export Pdf"><i class="fas fa-print"></i> Print</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="col"
                ...
                <a class="btn btn-success btn-sm"
                   ...
                   data-bs-placement="top"
                   title="Export PDF"
                   href="pages/pdf.php?detail=<?= $row['nip'] ?>"><i class="fas fa-print"></i>
                    Print</a>
            </div>
            ...
            <table class="table table-bordered">
                <thead class="text-center table table-success">
                    <tr>
                        <th rowspan="2"
                            class="align-middle">No</th>
                        <th rowspan="2"
                            class="align-middle">NIP</th>
                        <th rowspan="2"
                            class="align-middle">Nama</th>
                        <th rowspan="2"
                            class="align-middle">Jabatan</th>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php
								...
								$ak = ($tot_arr['atasan'] * $set[0]);
								$ak = ($tot_arr['atasan'] * 0.5);
