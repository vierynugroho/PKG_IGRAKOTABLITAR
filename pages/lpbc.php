...
<div class="container">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Laporan Penilaian Kinerja Guru</li>
		</ol>
	</nav>
		...
		<div class="row">
			<div class="col">
				...
				<table class="table table-responsive" id="myTable">
					...
					<tfoot>
						<tr>
							<th colspan="8">Total Nilai Kinerja
								<?= "($tot_arr[atasan]*50%) + ($tot_arr[guru]*30%) + ($tot_arr[sendiri]*20%)"; ?> =
							</th>
							<th>
								<?php
