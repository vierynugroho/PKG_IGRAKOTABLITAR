...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"
                aria-current="page">Laporan Penilaian Kinerja</li>
        </ol>
    </nav>
    ...
    <div class="shadow mb-4 p-3">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"
                                    id="exampleModalCenterTitle">Rentang Nilai Akhir dan Keterangan
                                </h5>
                                <button type="button"
                                        class="close"
        ...
        <div class="row">
            <div class="col-12">
                <form action="index.php?p=laporanpen"
                      method="get"
                      id="frm_ta">
                    <div class="form-group">
                        <select class="form-select cb_periode"
                                name="idta">
                            <?php
        ...
        <div class="row">
            <div class="col-12"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="chart-nilai-perkompetensi"
                             class="overflow-auto"></div>
                    </div>
                </div>
            </div>
